...
RegistryKey::RegistryKey(meta::open_existing_t, SharedRegistryKey handle, AccessRight rights, 
...
RegistryKey::RegistryKey(meta::open_existing_t, RegistryKey const& key, std::wstring_view child, AccessRight rights, 
	std::shared_ptr<RegistryApi> api)
...
RegistryKey::RegistryKey(meta::create_new_t, RegistryKey const& parent, std::wstring_view child, AccessRight rights, 
	std::shared_ptr<RegistryApi> api)
